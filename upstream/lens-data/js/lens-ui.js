...
angular.module("lens.ui", ["lens.ui.tpls", "lens.ui.transition","lens.ui.collapse","lens.ui.accordion","lens.ui.alert","lens.ui.bindHtml","lens.ui.buttons","lens.ui.carousel","lens.ui.dateparser","lens.ui.position","lens.ui.datepicker","lens.ui.dropdown","lens.ui.modal","lens.ui.pagination","lens.ui.tooltip","lens.ui.popover","lens.ui.progressbar","lens.ui.rating","lens.ui.tabs","lens.ui.timepicker","lens.ui.typeahead", "lens.ui.radio", "lens.ui.checkbox", "lens.ui.radial", "lens.ui.locationbar"], function($compileProvider) {
  $compileProvider.imgSrcSanitizationWhitelist(/(app|lens):/);
})
...
angular.module('lens.ui.transition', [])
...
angular.module('lens.ui.collapse', ['lens.ui.transition'])
...
angular.module('lens.ui.accordion', ['lens.ui.collapse'])
...
angular.module('lens.ui.bindHtml', [])
...
angular.module('lens.ui.buttons', [])
...
/**
* @ngdoc overview
* @name lens.ui.carousel
*
* @description
* AngularJS version of an image carousel.
*
*/
angular.module('lens.ui.carousel', ['lens.ui.transition'])
...
/**
 * @ngdoc directive
 * @name lens.ui.carousel.directive:carousel
 * @restrict EA
 *
 * @description
...
/**
 * @ngdoc directive
 * @name lens.ui.carousel.directive:slide
 * @restrict EA
 *
 * @description
 * Creates a slide inside a {@link lens.ui.carousel.directive:carousel carousel}.  Must be placed as a child of a carousel element.
 *
...
angular.module('lens.ui.dateparser', [])
...
angular.module('lens.ui.position', [])
...
angular.module('lens.ui.datepicker', ['lens.ui.dateparser', 'lens.ui.position'])
...
angular.module('lens.ui.dropdown', [])
...
angular.module('lens.ui.modal', ['lens.ui.transition'])
...
angular.module('lens.ui.pagination', [])
 ...
 */
angular.module( 'lens.ui.tooltip', [ 'lens.ui.position', 'lens.ui.bindHtml' ] )
...
.provider( '$tooltip', function () {
   ...
   * application.
   *
   *   var app = angular.module( 'App', ['lens.ui.tooltip'], function( $tooltipProvider ) {
 ...
 */
angular.module( 'lens.ui.popover', [ 'lens.ui.tooltip' ] )
...
angular.module('lens.ui.progressbar', [])
...
/**
 * @ngdoc directive
 * @name lens.ui.tabs.directive:tabset
 * @restrict EA
 *
 * @description
...
/**
 * @ngdoc directive
 * @name lens.ui.tabs.directive:tab
 * @restrict EA
 *
 * @param {string=} heading The visible heading, or title, of the tab. Set HTML headings with {@link lens.ui.tabs.directive:tabHeading tabHeading}.
 * @param {string=} select An expression to evaluate when the tab is selected.
 * @param {boolean=} active A binding, telling whether or not this tab is selected.
 * @param {boolean=} disabled A binding, telling whether or not this tab is disabled.
 *
 * @description
 * Creates a tab with a heading and content. Must be placed within a {@link lens.ui.tabs.directive:tabset tabset}.
 *
 * @example
<example module="lens.ui">
  <file name="index.html">
...
/**
 * @ngdoc directive
 * @name lens.ui.tabs.directive:tabHeading
 * @restrict EA
 *
 * @description
 * Creates an HTML heading for a {@link lens.ui.tabs.directive:tab tab}. Must be placed as a child of a tab element.
 *
 * @example
<example module="lens.ui">
  <file name="index.html">
...
angular.module('lens.ui.timepicker', [])
...
angular.module('lens.ui.typeahead', ['lens.ui.position', 'lens.ui.bindHtml'])
...
angular.module('lens.ui.checkbox', [])
...
angular.module('lens.ui.locationbar', [])
  .directive('locationbar', function () {
    return {
      restrict: 'E',
      scope: {},
      replace: true,
      template: '<input type="text" class="form-control" value="{{url}}" disabled>',
      link: function(scope) {
